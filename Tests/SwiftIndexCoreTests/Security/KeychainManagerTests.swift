...
final class KeychainManagerTests: XCTestCase {
        ...
        // MARK: - Platform Unavailable Tests

        func testPlatformUnavailable() {
            // This test runs on non-Apple platforms where Security.framework is unavailable
            // KeychainManager methods should not be available
            print("KeychainManager tests skipped: Security.framework not available on this platform")
        }
