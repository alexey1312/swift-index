...
- [x] **GATE A:** `swiftindex install-claude-code` works
- [x] **GATE A:** `swiftindex install-cursor` works
- [x] **GATE A:** `swiftindex install-codex` works
- [x] **GATE A:** All tests pass
...
- [x] B.2.5 Add unit tests

### B.3 Gate: Embedding Providers Complete

- [x] **GATE B:** SwiftEmbeddingsProvider returns real embeddings
- [x] **GATE B:** MLXEmbeddingProvider returns real embeddings
- [x] **GATE B:** Cosine similarity between similar texts > 0.8
- [x] **GATE B:** Tests pass
...
- [x] C.1.1 Run `./bin/mise run build`
- [x] C.1.2 Run `./bin/mise run test`
- [x] C.1.3 Run `./bin/mise run lint`

### C.2 Manual Testing

- [x] C.2.1 Test `swiftindex install-claude-code`
- [x] C.2.2 Test `swiftindex install-cursor`
- [x] C.2.3 Test `swiftindex install-codex`
- [x] C.2.4 Test embedding generation with `swiftindex index`
